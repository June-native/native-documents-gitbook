...
Deposits are not a `/trade` action — they are on-chain transfers into a vault contract on the source chain. [Deposit & withdraw](deposit-and-withdraw.md) walks both directions end to end, including how to confirm each one settled.
