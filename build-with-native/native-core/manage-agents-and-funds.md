...
{% hint style="warning" %}
If the account has an [account multisig](account-multisig.md) Active, every action on this page is **quorum-signed instead of owner-signed** — a lone owner signature is rejected with `AccountMultisigRequired`.
{% endhint %}
...
* [Account Multisig](account-multisig.md) — put a signer quorum in front of every action on this page
