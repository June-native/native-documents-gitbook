...
* [Native Core API](build-with-native/native-core/README.md)
  * [Guides](build-with-native/native-core/guides.md)
    ...
    * [Stream over WebSocket](build-with-native/native-core/stream-over-websocket.md)
...
* [Deposit & Withdraw](build-with-native/deposit-withdraw/README.md)
  * [Deposit](build-with-native/deposit-withdraw/deposit.md)
  * [Withdraw](build-with-native/deposit-withdraw/withdraw.md)
  * [Vault Contract](build-with-native/deposit-withdraw/vault-contract.md)
...
* [Wallets, Aggregators & Solvers](build-with-native/swap-aggregators/README.md)
  ...
  * [pAMM Swap APIs](build-with-native/swap-aggregators/pamm-swap-apis/README.md)
    * [Address References](build-with-native/swap-aggregators/pamm-swap-apis/addresses.md)
    * [Quote and Swap](build-with-native/swap-aggregators/pamm-swap-apis/quote-and-swap.md)
    * [Events](build-with-native/swap-aggregators/pamm-swap-apis/events.md)
    * [Error Handling](build-with-native/swap-aggregators/pamm-swap-apis/error-handling.md)
...
* [Market Makers (Deprecated)](build-with-native/market-makers-deprecated/README.md)
  * [MM Pricing and Signing API](build-with-native/market-makers-deprecated/mm-pricing-and-signing-api/README.md)
    * [Orderbook](build-with-native/market-makers-deprecated/mm-pricing-and-signing-api/orderbook.md)
    * [Firm-Quote](build-with-native/market-makers-deprecated/mm-pricing-and-signing-api/firm-quote.md)
    * [Sign-Quote](build-with-native/market-makers-deprecated/mm-pricing-and-signing-api/sign-quote.md)
    * [On-chain events for swap](build-with-native/market-makers-deprecated/mm-pricing-and-signing-api/on-chain-events-for-swap.md)
    * [Testing your API](build-with-native/market-makers-deprecated/mm-pricing-and-signing-api/testing-your-api.md)
  * [API Guide](build-with-native/market-makers-deprecated/api-guide/README.md)
    * [WebSocket Integration](build-with-native/market-makers-deprecated/api-guide/websocket-integration/README.md)
      * [Orderbook](build-with-native/market-makers-deprecated/api-guide/websocket-integration/orderbook.md)
      * [Firm-Quote](build-with-native/market-makers-deprecated/api-guide/websocket-integration/firm-quote.md)
      * [Sign-Quote](build-with-native/market-makers-deprecated/api-guide/websocket-integration/sign-quote.md)
      * [On-chain events for swap](build-with-native/market-makers-deprecated/api-guide/websocket-integration/on-chain-events-for-swap.md)
    * [Using Native Credit Pool](build-with-native/market-makers-deprecated/api-guide/using-native-credit-pool.md)
  * [Native Market Makers API](build-with-native/market-makers-deprecated/native-market-makers-api/README.md)
    * [GET Market maker info](build-with-native/market-makers-deprecated/native-market-makers-api/get-market-maker-info.md)
    * [GET Market maker settings](build-with-native/market-makers-deprecated/native-market-makers-api/get-market-maker-settings.md)
    * [GET Token settings](build-with-native/market-makers-deprecated/native-market-makers-api/get-token-settings.md)
    * [GET Market maker positions](build-with-native/market-makers-deprecated/native-market-makers-api/get-market-maker-positions.md)
    * [GET Available borrows](build-with-native/market-makers-deprecated/native-market-makers-api/get-available-borrows.md)
    * [POST Verify settlement](build-with-native/market-makers-deprecated/native-market-makers-api/post-verify-settlement.md)
    * [POST Request settlement](build-with-native/market-makers-deprecated/native-market-makers-api/post-request-settlement.md)
    * [POST Cancel settlement](build-with-native/market-makers-deprecated/native-market-makers-api/post-cancel-settlement.md)
    * [POST Settlement status](build-with-native/market-makers-deprecated/native-market-makers-api/post-settlement-status.md)
    * [POST Verify collateral removal](build-with-native/market-makers-deprecated/native-market-makers-api/post-verify-collateral-removal.md)
    * [POST Request collateral removal](build-with-native/market-makers-deprecated/native-market-makers-api/post-request-collateral-removal.md)
    * [POST Cancel collateral removal](build-with-native/market-makers-deprecated/native-market-makers-api/post-cancel-collateral-removal.md)
    * [POST Collateral removal status](build-with-native/market-makers-deprecated/native-market-makers-api/post-collateral-removal-status.md)
    * [POST Liquidation](build-with-native/market-makers-deprecated/native-market-makers-api/post-liquidation.md)
    * [GET All market maker settings](build-with-native/market-makers-deprecated/native-market-makers-api/get-all-market-maker-settings.md)
