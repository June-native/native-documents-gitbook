...
{% hint style="info" %}
Looking for the previous credit-pool and RFQ-based design? It now lives under [**Native Relay**](modules/native-relay.md), with detailed references preserved in the [Legacy (V2)](legacy/about-native-v2.md) section.
{% endhint %}
