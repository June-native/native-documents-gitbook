...
Relay is also the home of Native's original RFQ-based distribution model (see [Compatibility with the V2 model](native-relay.md#compatibility-with-the-v2-model) below).
